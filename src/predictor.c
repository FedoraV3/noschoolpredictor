...
/** @brief Clamps a floating-point value to an inclusive range. */
...
/** @brief Normalizes a value to the range from zero to one. */
...
/** @brief Applies a numerically bounded sigmoid function. */
...
/** @brief Maps an Open-Meteo weather code to a severity score. */
...
/** @brief Classifies a percentage probability into a risk level. */
